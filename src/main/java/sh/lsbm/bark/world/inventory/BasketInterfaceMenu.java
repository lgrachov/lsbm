...
package sh.lsbm.bark.world.inventory;
...
public class BasketInterfaceMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BasketInterfaceMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsbmModMenus.BASKET_INTERFACE.get(), id);
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 79, 35) {
